...
public class b2World
{
	...
	*/
	...
	public function ClearDynamicObjects(displayObject:Sprite = null):void {
		var body:b2Body = GetBodyList();
		
		while (body != null) {
			if (body.GetType() == b2Body.b2_dynamicBody) {
				
				if (body.GetUserData() is Sprite && displayObject != null && displayObject.contains(body.GetUserData())) {
					displayObject.removeChild(body.GetUserData());
				}
