...
package deng.fzip {
	...
	public class FZipLibrary extends EventDispatcher {
		...
		//EXTENDED BY PAUL TO TELL ME HOW MANY FILES
		private var totalFilesToProcess:uint = 0;
		private var totalFilesLoaded:uint = 0;
		...
		public function addZip(zip:FZip):void {
			totalFilesToProcess += zip.getFileCount();
		...
		private function loaderCompleteHandler(evt:Event):void {
			...
			//ADDED BY PAUL
			totalFilesLoaded++;
			if(totalFilesLoaded % 4 == 0) dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS, false, false, totalFilesLoaded, totalFilesToProcess));
