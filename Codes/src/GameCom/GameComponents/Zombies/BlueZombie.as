package GameCom.GameComponents.Zombies 
{
	...
	public class BlueZombie extends Sprite implements IZombie {
		...
		public function BlueZombie() {
			animation.AddFrame(ThemeManager.Get("Zombies/Base Zombie Blue/1.png"));
			animation.AddFrame(ThemeManager.Get("Zombies/Base Zombie Blue/2.png"));
			animation.AddFrame(ThemeManager.Get("Zombies/Base Zombie Blue/3.png"));
			animation.AddFrame(ThemeManager.Get("Zombies/Base Zombie Blue/4.png"));
			animation.AddFrame(ThemeManager.Get("Zombies/Base Zombie Blue/5.png"));
			animation.AddFrame(ThemeManager.Get("Zombies/Base Zombie Blue/6.png"));
			animation.AddFrame(ThemeManager.Get("Zombies/Base Zombie Blue/7.png"));
			animation.AddFrame(ThemeManager.Get("Zombies/Base Zombie Blue/8.png"));
